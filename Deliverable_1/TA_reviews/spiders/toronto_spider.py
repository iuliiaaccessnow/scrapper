...
class LondonSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs): 
        ...
        self.max_review_pages = 100 # 10 reviews per page
         
    def start_requests(self):
        ''' '''
        url = 'https://www.tripadvisor.com/Restaurants-g155019-zfn15622863-Toronto_Ontario.html'
    ...
    def parse_resto(self, response, pages_parsed):
        ...
        if current_page == 1:
            ...
            resto_item['resto_address'] = response.xpath('//div[@data-test-target="restaurant-detail-info"]/div/span/span/a/text()').extract()
